<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BoschOnay.Master" CodeBehind="FBoschRapor03.aspx.vb" Inherits="BoschOnay.FBoschRapor03" %>
        ...
        <tr>
            <td valign="top" style="height: 100%;">
                <telerik:ReportViewer ID="RaporGoster" runat="server" Width="100%" Height="100%" ProgressText="Rapor hazırlanıyor..." ShowHistoryButtons="False" ShowParametersButton="False" ShowPrintPreviewButton="False" ShowRefreshButton="False" ViewMode="PrintPreview">
                    <typereportsource typename="BoschOnay.BoschRapor03, BoschOnay, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null"></typereportsource>
