<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/BoschOnay.Master" CodeBehind="FUsers.aspx.vb" Inherits="BoschOnay.FUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <tr>
            ...
            <td valign="top" align="left" style="width: 100%;">
                <table style="height: 100%;">
                        ...
                        <td style="border: 1px solid lightgray">
                            <table style="border: none; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 12px; font-weight: lighter;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="Username" runat="server" MaxLength="50" Width="200px" Font-Names="Segoe UI" Font-Size="12px" /></td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="Email" runat="server" MaxLength="100" Width="200px" Font-Names="Segoe UI" Font-Size="12px" /></td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="euser" runat="server" Font-Size="12px" Text="" Checked="false" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="height: 100%">
                        <td>
                            <telerik:RadGrid ID="RadGrid2" runat="server" AllowSorting="true" Width="460px" Height="100%" AutoGenerateColumns="False" OnPreRender="RadGrid2_PreRender"
                                ...
                                <MasterTableView EditMode="Batch">
                                    <Columns>
                                        <telerik:GridBoundColumn DataField="Kodu" HeaderText="Organizasyon Birimi" UniqueName="Kodu" HeaderStyle-Width="250px" ReadOnly="true" />

                                        <telerik:GridTemplateColumn HeaderText="Yetki" UniqueName="Yetki" HeaderStyle-Width="50px">
                                            <ItemTemplate>
                                                <asp:CheckBox runat="server" ID="CheckBox1" Enabled="true" />
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>

                                        <telerik:GridTemplateColumn HeaderText="Yetki Değişikliği" UniqueName="YetkiTmp" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Value="0">Ekle</asp:ListItem>
                                                    <asp:ListItem Value="1">Sil</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
                    ...
                    <tr>
                        <td align="center">
                            <asp:Label ID="Mesaj" runat="server" Font-Names="Calibri" Font-Size="14px" ForeColor="Red" Text=""></asp:Label></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <asp:HiddenField ID="PerListTmp" runat="server" />
</asp:Content>
